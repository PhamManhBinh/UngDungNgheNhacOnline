...
public class BaiHatGoiYAdapter extends RecyclerView.Adapter<BaiHatGoiYAdapter.BaiHatViewHolder> {
    Context context;
    ArrayList<BaiHat> listBaiHat;

    public BaiHatGoiYAdapter(Context context, ArrayList<BaiHat> listBaiHat) {
    ...
    public BaiHatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.dong_item_baihat_goi_y,parent,false);
    ...
    public static class BaiHatViewHolder extends RecyclerView.ViewHolder{
        ...
        public BaiHatViewHolder(@NonNull View itemView) {
            super(itemView);
            imgBaiHat=itemView.findViewById(R.id.imageviewBaiHat_goi_y);
            tenBaiHat=itemView.findViewById(R.id.textviewTenBaiHat_goi_y);
            tenCaSi=itemView.findViewById(R.id.textviewTenCaSi_goi_y);
            love=itemView.findViewById(R.id.dong_item_baihat_goi_y_love);
        }
    }
}
